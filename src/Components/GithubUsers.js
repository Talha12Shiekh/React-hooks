...
const GithubUsers = (props) => {
  return (
    <>
                  <h2 className='text-center mt-1'>List of Github Users</h2>
            <div className="container-fluid mt-5">
                <div className="row text-center">

                    {
                        props.users.map((element)=>{
                            const {avatar_url,name,username,id} = element;
                            return ( 

                    <div className="col-10 col-md-6 mt-5" key={id}>
                        <div className="card p-2">
                            <div className="d-flex align-items-center">
                                <div className="image"> <img src="https://via.placeholder.com/150" alt='Gihub user' className="rounded" width="155" /> </div>
